...
public class PatientGroupController {
    ...
    @Operation(summary = "获取分组中的患者ID列表")
    ...
    @Operation(summary = "获取医生的所有患者详细信息")
